...
* remove folder theme/remui/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/remui/scss/bootstrap
...
* comment out this line in theme/remui/scss/_print.scss
    @page {
...
* remove folder theme/remui/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/remui/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/remui/amd/src
* edit theme/remui/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/remui run "grunt amd" to compile the bootstrap JS
* in folder theme/remui run "grunt css" to compile scss
