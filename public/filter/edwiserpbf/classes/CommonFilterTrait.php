...
trait CommonFilterTrait {
    ...
    /**
     * Filter the text and replace edwiser shortcodes with generated content.
     *
    ...
    public function filter($text, array $options = []) {
        ...
        // Courses pregmatch.
        $pregmatch = "(\[edwiser\-courses[ ]+(catid)\=[\'\"’‘“”]([a-zA-Z0-9,]+)"
        . "[\'\"’‘“”][ ](layout)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]\])";
        ...
        $pregmatch = "(\[edwiser\-categories[ ]+(layout)\=[\'\"’‘“”]([a-zA-Z0-9]*)[\'\"’‘“”]"
        . "[ ](btnlabel)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]"
        . "[ ](count)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]\])";
        ...
        // Categories pregmatch.
        $pregmatch = "(\[edwiser\-cnc[ ]+(layout)\=[\'\"’‘“”]([a-zA-Z0-9]*)[\'\"’‘“”]"
        . "[ ](show)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]"
        . "[ ](catid)\=[\'\"’‘“”]([a-zA-Z0-9,]+)[\'\"’‘“”]"
        . "[ ](date)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]\])";
        ...
        $pregmatch = "(\[edwiser\-fc[ ]+(layout)\=[\'\"’‘“”]([a-zA-Z0-9]*)[\'\"’‘“”]"
        . "[ ](show)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]"
        . "[ ](courseid)\=[\'\"’‘“”]([a-zA-Z0-9,]+)[\'\"’‘“”]"
        . "[ ](date)\=[\'\"’‘“”]([a-zA-Z0-9]+)[\'\"’‘“”]\])";
        ...
        foreach ($matches as $key => $match) {
            ...
            foreach ($attributes as $attribute) {
                $tags[$key][] = [$attribute[1]];
                $tags[$key][] = [$attribute[2]];
            }
        }
