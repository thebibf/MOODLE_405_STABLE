...
/**
 * Edwiser Page Builder Filter functions.
...
function get_course_teacher($course) {
    ...
    foreach ($instructors as $key => $instructor) {
        return [
            ...
            'picture' => get_user_picture($DB->get_record('user', ['id' => $key])),
        ];
    }
    return null;
}
...
/**
 * Check if a plugin is available by its component name.
 *
 * @param string $component The plugin component name.
 * @return bool True if the plugin directory exists, false otherwise.
 */
