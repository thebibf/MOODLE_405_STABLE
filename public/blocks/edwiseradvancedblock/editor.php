...
/**
 * Editor page for block_edwiseradvancedblock.
 *
...
$PAGE->set_url('/blocks/edwiserblocks/editor.php', ['bui_edit' => $blockinstance]);
...
if (!is_null($config)) {
    // When editing block a 2nd time, multilang content is not visible because format_text
    // shows strings according to lang. To solve this, we format_text only the necessary ones,
    // in this case shortcodes for dynamic blocks (enclosed within `[]`).
