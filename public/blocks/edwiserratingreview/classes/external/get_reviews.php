...
trait get_reviews {
    ...
    public static function get_reviews_parameters() {
        ...
        return new external_function_parameters(
            ...
            array(
                ...
                'sortcolumn' => new external_value(PARAM_ALPHA, 'Column to sort by: date or coursename'),
     ...
     */
    public static function get_reviews($start, $length, $order, $sortcolumn, $mindate, $maxdate, $loadonlypending) {
        global $PAGE;
        ...
        $reviewdata = $rm->get_reviews_by_filter($start, $length, $order, $mindate, $maxdate, $loadonlypending, $sortcolumn);
