...
/**
 * Theme customizer color utilities module.
 * Provides functionality to manipulate colors including hex to RGB conversion and color shading.
 *
 * @module     theme_remui/customizer/color-utils
