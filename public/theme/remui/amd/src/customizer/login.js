...
/**
 * Theme customizer login page module.
 * Handles login page customization settings including background images and styling.
 *
 * @module     theme_remui/customizer/login
