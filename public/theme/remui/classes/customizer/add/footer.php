...
trait footer {
    ...
    private function add_main_footer_area_background_img() {
        ...
        // Hidden store for the computed default background image URL.
        $this->add_setting(
            'hidden',
            'footerbackgroundimgdefault',
            '',
            $panel
        );
    ...
    private function add_footer_advance_settings() {
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            if ($i === 1) {
                ...
                // Hidden store for the computed default widget logo URL.
                $this->add_setting(
                    'hidden',
                    'footerwidgetlogodefault',
                    '',
                    $panel
                );
            }
