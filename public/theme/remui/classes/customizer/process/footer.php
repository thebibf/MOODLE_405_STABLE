...
trait footer {
    ...
    private function process_footer(&$variables) {
        ...
        if (empty($footerbackgroundimg)) {
            $footerbackgroundimg = $this->get_config('footerbackgroundimgdefault');

            if (empty($footerbackgroundimg)) {
                $backgrounds = [
                    'footer-design-1' => 'FooterDesignBg1.svg',
                    'footer-design-2' => 'FooterDesignBg2.svg',
                    'footer-design-3' => 'FooterDesignBg3.svg',
                    'footer-design-4' => 'FooterDesignBg4.svg',
                    'footer-design-6' => 'FooterDesignBg6.svg',
                ];

                if (isset($backgrounds[$footerselectedtemplate])) {
                    $footerbackgroundimg = 'https://qastaticcdn.edwiser.org/theme_remuiassets/footerassets/images/'
                        . $backgrounds[$footerselectedtemplate];
                }
            }
        }
