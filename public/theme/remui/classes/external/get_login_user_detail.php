...
/**
 * Get login user detail trait.
 *
 * Provides external API functions for getting login user details.
 */
trait get_login_user_detail {
    /**
     * Describes the parameters for get_login_user_detail.
     *
     ...
     *
     * @return string HTML data for logged in user
     */
    ...
    /**
     * Describes the return value for get_login_user_detail.
     *
