...
/**
 * Page model class for Edwiser Page Builder.
 *
...
/**
 * Model class representing a page in Edwiser Page Builder.
 */
class page_model {
    /** @var int Page ID. */
    private $id;
    ...
    private $pagename;
    /** @var string JSON encoded capabilities. */
    ...
    private $pagelayout;
    /** @var int Start date timestamp. */
    private $startdate;
    /** @var int End date timestamp. */
    private $enddate;
    /** @var int Page modified timestamp. */
    private $pagemodified;
    /** @var string Page description. */
    private $pagedesc;
    /** @var int Allow logged in users only flag. */
    ...
    private $seodesc;
    /** @var int Allow indexing flag. */
    private $allowindex;
    /** @var int Reference ID. */
    private $refid;
    /** @var string Page type draft or publish. */
    private $type = "draft";

    /** @var array Block instances. */
    private $blocks = [];

    /** @var string Current page table name. */
    public $pagetable;

    /** @var string Publish table name. */
    public $publishtable = "local_edwiserpagebuilder_pages";
    /** @var string Draft table name. */
    public $drafttable = "local_edwiserpagebuilder_pagesdraft";
    /** @var string Draft page type identifier. */
    public $draftpagetype = "epb-page-draft";
    /** @var string Publish page type identifier. */
    public $publishpagetype = "epb-page-publish";

    /**
     * Constructor to initialize page model with defaults.
     */
    public function __construct() {
        $this->set_pagename("");
        $this->set_capabilities(json_encode([]));
    ...
    public function initialize_page($pageid) {
        ...
        if (!$page) {
            throw new \moodle_exception(
                ...
                '',
                null,
                'epb_pageidnotfound: ' . get_string('accesserror', "local_edwiserpagebuilder")
            );
        }
     ...
     *
     * @param int $pageid
     * @return object|false page db object
     */
    public function get_page_record_by_id($pageid) {

        global $DB;

        $param = ['id' => $pageid, 'deleted' => 0];
    ...
    /**
     * Generate an object suitable for database insertion or update.
     *
     * @return stdClass
     */
     ...
     *
     * @param array $tablecontraints
     * @return object|false
     */
    public function get_layout_block_content($tablecontraints) {
        global $DB;

        $blocklayoutable = 'local_edwiserpagebuilder_blocks';
