...
/**
 * This is the external method used for updating pro blocks.
 *
...
/**
 * Trait for updating pro blocks external functions.
 */
trait edwiser_update_pro_blocks {
    /**
     * Describes the parameters for execute.
     *
     * @return external_function_parameters
     */
    public static function edwiser_update_pro_blocks_parameters() {
    ...
    /**
     * Execute the pro blocks updating operation with batching support.
     *
     ...
     */
    public static function edwiser_update_pro_blocks($limit = false, $offset = 0) {
        global $CFG;
        ...
        try {
            $result = local_edwiserpagebuilder_update_pro_block_content($limit, $offset);
     ...
     */
    public static function edwiser_update_pro_blocks_returns() {
