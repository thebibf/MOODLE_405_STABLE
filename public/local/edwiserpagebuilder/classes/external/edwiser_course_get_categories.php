...
/**
 * External functions for retrieving course categories.
 *
...
trait edwiser_course_get_categories {
    ...
    public static function edwiser_course_get_categories_parameters() {
        return new external_function_parameters(
            [
                    ...
                    new external_single_structure(
                        [
                            'key' => new external_value(
                                ...
                                ' - user must have \'moodle/category:manage\'' .
                                ' or \'moodle/category:viewhiddencategories\' to search on visible,' .
                ...
                'addsubcategories' => new external_value(
                    PARAM_BOOL,
     ...
     */
    public static function edwiser_course_get_categories($criteria = [], $addsubcategories = true) {
        global $CFG, $DB;
        ...
        $params = self::validate_parameters(
            self::edwiser_course_get_categories_parameters(),
            ['criteria' => $criteria, 'addsubcategories' => $addsubcategories]
        );
        ...
        if (!empty($params['criteria'])) {
                ...
                if (!isset($conditions[$key])) {
                    ...
                    switch ($key) {
                        ...
                        case 'ids':
                            ...
                            $ids = explode(',', $value);
                            [$sqlids, $paramids] = $DB->get_in_or_equal($ids, SQL_PARAMS_NAMED);
            ...
            if (!empty($wheres)) {
                ...
                if ($categories && !empty($params['addsubcategories'])) {
                    $newcategories = [];
                    ...
                    foreach ($categories as $category) {
                        ...
                        // It will NOT include the specified category.
                        $sqlparams = ['path' => $category->path . '/%'] + $additionalparams;
        ...
        foreach ($categories as $category) {
            ...
            foreach ($parents as $parentid) {
                ...
                if (isset($excludedcats[$parentid]) && $excludedcats[$parentid] != 'context') {
            ...
            if (!isset($excludedcats[$category->id])) {
                ...
                if (\core_course_category::can_view_category($category)) {
                    ...
                    [$categoryinfo['description'], $categoryinfo['descriptionformat']] =
