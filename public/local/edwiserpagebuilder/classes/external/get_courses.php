...
/**
 * External functions for retrieving courses.
 *
...
/**
 * Trait for get courses external functions.
 */
trait get_courses {
    /**
    ...
    public static function get_courses($limitstart, $limitend, $categorylist) {
        ...
        [$totalcoursecount, $courses] = $coursehandler->get_courses(false, null, $categorylist, $limitstart, $limitend);
        $templatedata = ['courses' => $courses];
        $data = $OUTPUT->render_from_template('filter_edwiserpbf/coursecard', $templatedata);
        return $data;
    }
