...
/**
 * External functions for getting frontpage section courses in category.
 *
...
/**
 * Trait for get frontpage section courses in category external functions.
 */
trait get_frontpage_section_courses_in_category {
    ...
    public static function get_frontpage_section_courses_in_category($instanceid, $categoryid = 0, $start = 0) {
        ...
        [$configdata['totalcourse'], $configdata['courses']] = get_courses_from_category($categories, $date, $start);
