...
/**
 * This class will handle every operations related to quiz attempts.
 */
class quizattempts {
    /**
    ...
    /**
     * Check if user can view quiz attempts.
     *
    ...
    public function get_quiz_participation($courseid, $quizid) {
        ...
        if (!empty($enrolledstudents)) {
            ...
            $quizdata = $DB->get_records_sql($sqlq, [$quizid]);
    ...
    public function get_quizzes_of_course($courseid) {
        ...
        $quizzes = $DB->get_records_sql($sqlq, [$courseid]);
