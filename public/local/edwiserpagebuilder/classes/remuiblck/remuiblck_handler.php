...
/**
 * Handler class for remuiblck web service actions.
 */
class remuiblck_handler {
    /**
     * Handle the latest members web service call.
     *
    ...
    /**
     * Handle the Add Notes web service call.
     *
     * @param string $config Configuration data.
     * @return array
     */
    ...
    /**
     * Handle the Recent Feedback web service call.
     *
     * @param string $config Configuration data.
     * @return array
     */
    ...
    /**
     * Handle the Recent Forum web service call.
     *
     * @param string $config Configuration data.
     * @return array
     */
    ...
    /**
     * Handle Course Progress list service.
     *
     * @param string $config Configuration data.
     * @return array
     */
    ...
    /**
     * Handle Course Progress service.
     *
     * @param string $config Configuration data.
     * @return stdClass
     */
    ...
    /**
     * Handle send message service for all blocks.
     *
     * @param string $config Configuration data.
    ...
    public function action_send_message($config) {
        global $USER, $DB, $SITE;
        $config = json_decode($config);
        $userfrom = $DB->get_record('user', ['id' => $USER->id], '*', MUST_EXIST);
        $userto = $DB->get_record('user', ['id' => $config->studentid], '*', MUST_EXIST);
    ...
    /**
     * Get dropping off students data.
     *
     * @param string $config Configuration data.
     * @return array
     */
    public function action_get_dropping_off_students($config) {
        ...
        $coursehandler = \local_edwiserpagebuilder\remuiblck\coursehandler::get_instance();
        $users = $coursehandler->get_filtered_dropping_user_stats(
            $config->courseid,
            $config->search,
            true,
            $config->start,
    ...
    /**
     * Export dropping off students data.
     *
     * @param string $config Configuration data.
     * @return array
     */
    public function action_export_dropping_off_students($config) {
        ...
        $coursename = $DB->get_field('course', 'shortname', ['id' => $config->courseid]);
        return [
    ...
    /**
     * Handle course analytics web service call.
     *
     * @param string $config Configuration data.
     * @return mixed
     */
    ...
    /**
     * Handle the enrolled users block web service call.
     *
     * @param string $config Configuration data.
     * @return mixed
     */
    ...
    /**
     * Handle the quiz attempts web service call.
     *
     * @param string $config Configuration data.
     * @return mixed
     */
    ...
    /**
     * Handle the quizzes of course web service call.
     *
     * @param string $config Configuration data.
     * @return mixed
     */
    ...
    /**
     * Generate content of the RemUI blocks.
     *
     * @param array $tags Block tags.
    ...
    public function get_content($tags) {
        ...
        if ($PAGE->pagetype == "blocks-edwiserblocks-editor" || isset($tags["editorpage"])) {
            ...
            return $OUTPUT->render_from_template(
                "local_edwiserpagebuilder/remuiblck/uneditable_warning_msg",
