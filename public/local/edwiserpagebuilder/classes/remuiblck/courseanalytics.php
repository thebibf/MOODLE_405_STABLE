...
/**
 * Course analytics handler class.
 *
...
/**
 * This class will handle every operations related to course analytics.
 */
class courseanalytics {
    ...
    /**
     * Get course analytics data for a specific course.
     *
