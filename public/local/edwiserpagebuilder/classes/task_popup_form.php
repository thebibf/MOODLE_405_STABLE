...
class local_edwiserpagebuilder_task_popup_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'subject', get_string('subject', 'local_edwiserpagebuilder'), ['maxlength' => 500]);
        ...
        $mform->addElement(
            ...
            ['wrap' => 'virtual', 'rows' => 5, 'cols' => 50, 'maxlength' => 1000]
        );
