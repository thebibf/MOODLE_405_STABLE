...
let ComponentDeviceVisibility = {
	 properties: [{
		...
		data: {header:"Hide based on device screen width" + (typeof window._v9 !== 'undefined' && !window._v9 ? "<i class='fa fa-lock font-size-14 epb-pro-locked-primary-color'></i>" : "")},
	},
    //{
    ...
    //     },
    //     data: {
    //         on: (typeof window._v9 !== 'undefined' && !window._v9) ? "notapplicable" : "edw-xs-none",
    //         off: ""
    //     }
	// },
    {
        ...
        data: {
            on: (typeof window._v9 !== 'undefined' && !window._v9) ? "notapplicable" : "edw-sm-none",
            off: ""
        }
	}, {
        ...
        data: {
            on: (typeof window._v9 !== 'undefined' && !window._v9) ? "notapplicable" : "edw-md-none",
            off: ""
        }
	}, {
        ...
        data: {
            on: (typeof window._v9 !== 'undefined' && !window._v9) ? "notapplicable" : "edw-lg-none",
            off: ""
        }
	}, {
        ...
        data: {
            on: (typeof window._v9 !== 'undefined' && !window._v9) ? "notapplicable" : "edw-xl-none",
            off: ""
        }
	}, {
        ...
        data: {
            on: (typeof window._v9 !== 'undefined' && !window._v9) ? "notapplicable" : "edw-xxl-none",
            off: ""
        }
    }]
};
