...
let bgVideoTemplate = '<video playsinline loop muted autoplay src="https://staticcdn.edwiser.org/CDN/sample.webm" poster="https://staticcdn.edwiser.org/CDN/sample.webp"><video>';
let bgImageTemplate = '<img src="https://staticcdn.edwiser.org/CDN/sample.jpg">';
...
let SectionContent = [{
        ...
        key: "container-width",
        sort: section_sort++,
		child:":scope > .section-container, :scope > .container-fluid",
        htmlAttr: "class",
        ...
        sort: section_sort++,
        child:":scope > .section-container:first-child, :scope > .container-fluid:first-child",
        htmlAttr: "class",
        validValues: ["", "vh-100"],
        inputtype: RadioButtonInput,
        data: {
