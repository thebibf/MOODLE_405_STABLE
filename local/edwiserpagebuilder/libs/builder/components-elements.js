...
Vvveb.Components.add("elements/gallery", {
    ...
    html: `
			<div class="row gallery masonry has-shadow" data-component-gallery>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/1.jpeg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/2.jpeg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/3.jpeg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/4.jpeg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/5.jpeg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/6.jpeg">
					</a>
				</div>
				<div class="item">
					<a>
						<img src="https://staticcdn.edwiser.org/v40/CDN/grid_view/7.jpeg">
					</a>
				</div>
			</div>
			`,
    ...
    html: `<div class="accordion" id="accordion-parentId">
		  <div class="accordion-item">
			<h2 class="accordion-header" id="headingOne-parentId">
			  <button class="accordion-button" type="button" data-toggle="collapse" data-bs-toggle="collapse" data-target="#collapseOne-parentId" data-bs-target="#collapseOne-parentId" aria-expanded="true" aria-controls="collapseOne-parentId">
				Accordion Item #1
			  </button>
			</h2>
			<div id="collapseOne-parentId" class="accordion-collapse collapse show" aria-labelledby="headingOne-parentId" data-parent="#accordion-parentId" data-bs-parent="#accordion-parentId">
		  ...
		  <div class="accordion-item">
			<h2 class="accordion-header" id="headingTwo-parentId">
			  <button class="accordion-button collapsed" type="button" data-toggle="collapse" data-bs-toggle="collapse" data-target="#collapseTwo-parentId" data-bs-target="#collapseTwo-parentId" aria-expanded="false" aria-controls="collapseTwo">
				Accordion Item #2
			  </button>
			</h2>
			<div id="collapseTwo-parentId" class="accordion-collapse collapse" aria-labelledby="headingTwo-parentId" data-parent="#accordion-parentId" data-bs-parent="#accordion-parentId">
			  <div class="accordion-body">
				<p>Mauris viverra cursus ante laoreet eleifend. Donec vel fringilla ante. Aenean finibus velit id urna vehicula, nec maximus est sollicitudin</p>
			  </div>
			</div>
		  ...
		  <div class="accordion-item">
			<h2 class="accordion-header" id="headingThree-parentId">
			  <button class="accordion-button collapsed" type="button" data-toggle="collapse" data-bs-toggle="collapse" data-target="#collapseThree-parentId" data-bs-target="#collapseThree-parentId" aria-expanded="false" aria-controls="collapseThree">
				Accordion Item #3
			  </button>
			</h2>
			<div id="collapseThree-parentId" class="accordion-collapse collapse" aria-labelledby="headingThree-parentId" data-parent="#accordion-parentId" data-bs-parent="#accordion-parentId">
			  <div class="accordion-body">
				<p>Mauris viverra cursus ante laoreet eleifend. Donec vel fringilla ante. Aenean finibus velit id urna vehicula, nec maximus est sollicitudin</p>
			  </div>
			</div>
					...
					if (event.action == "add") {
						...
						node.append(generateElements(`<div class="accordion-item">
							<h2 class="accordion-header" id="heading-${index}-${random}">
							  <button class="accordion-button collapsed" type="button" data-toggle="collapse" data-bs-toggle="collapse" data-target="#collapse-${index}-${random}" data-bs-target="#collapse-${index}-${random}" aria-expanded="false" aria-controls="collapseTwo">Accordion Item #${index}</button>
							</h2>
							<div id="collapse-${index}-${random}" class="accordion-collapse collapse" aria-labelledby="heading-${index}-${random}" data-parent="#accordion-${accordionId}" data-bs-parent="#accordion-${accordionId}">
							  <div class="accordion-body">
...
function carouselAfterDrop(node) {
	...
	if (!body.querySelector("#swiper-js")) {
		...
		// Construct full path to swiper - Vvveb.baseUrl points to builder directory, go up one level to libs/swiper
		let swiperBasePath = '';
		if (Vvveb.baseUrl) {
			// Remove trailing slash and /builder if present, then add /swiper/
			swiperBasePath = Vvveb.baseUrl.replace(/\/builder\/?$/, '').replace(/\/$/, '') + '/swiper/';
		} else {
			...
			if (currentScript && currentScript.src) {
				...
				swiperBasePath = scriptPath.replace(/\/builder\/?$/, '') + '/swiper/';
			} else {
				// Last resort: use relative path
				swiperBasePath = '../swiper/';
			}
		}
		link.href = swiperBasePath + 'swiper-bundle.min.css';
		link.id = 'swiper-css';
		link.rel = 'stylesheet';
		lib.id = 'swiper-js';
		lib.type = 'text/javascript';
		lib.src = swiperBasePath + 'swiper-bundle.min.js';
...
Vvveb.Components.add("elements/image-compare", {
    ...
    html: `<div class="c-compare" style="--value:50%;">
	  <img class="c-compare__left" src="https://staticcdn.edwiser.org/v40/CDN/grid_view/1.jpeg" alt="" />
	  <img class="c-compare__right" src="https://staticcdn.edwiser.org/v40/CDN/grid_view/2.jpeg" alt="" />
	</div>`,
    properties: [
	]
});
